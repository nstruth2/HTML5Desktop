...
public class SubmitNameAndScoreOnlyGame8 : MonoBehaviour
{
    ...
    private string submitScoreURL = "https://ourgoodguide.com/HTML5DesktopProject/ScoreandNameSubmission/submit_score_game_8.php";
    private string checkRankURL = "https://ourgoodguide.com/HTML5DesktopProject/CheckRank/check_rank_game_8.php";
    private int score = 0;
    ...
    public IEnumerator SubmitScoreAndCheckRank(string playerName, int score)
    {
        ...
        PlayerPrefs.DeleteKey("Game8_SubmitScore");
    }
    ...
    {
        SceneManager.LoadScene("Gameplay Game 8"); // 🔹 Correct retry scene
    }
}
