...
public class SubmitNameAndScoreOnlyGame3 : MonoBehaviour
{
    ...
    private string submitScoreURL = "https://ourgoodguide.com/HTML5DesktopProject/ScoreandNameSubmission/submit_time_game_3.php";
    private string checkRankURL = "https://ourgoodguide.com/HTML5DesktopProject/CheckRank/check_rank_game_3.php";
    private string time_raw = "";

    private void Start()
    {
        time_raw = PlayerPrefs.GetString("Game3_SubmitTimeRaw", PlayerPrefs.GetString("Game3_SubmitTime", ""));
    ...
    {
        SceneManager.LoadScene("Gameplay Game 3"); // 🔹 Correct retry scene
    }
}
