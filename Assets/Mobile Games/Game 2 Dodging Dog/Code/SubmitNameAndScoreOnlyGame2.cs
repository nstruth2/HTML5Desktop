...
public class SubmitNameAndScoreOnlyGame2 : MonoBehaviour
{
    ...
    private string submitScoreURL = "https://ourgoodguide.com/HTML5DesktopProject/ScoreandNameSubmission/submit_score_game_2.php";
    private string checkRankURL = "https://ourgoodguide.com/HTML5DesktopProject/CheckRank/check_rank_game_2.php";
    private int score = 0;
