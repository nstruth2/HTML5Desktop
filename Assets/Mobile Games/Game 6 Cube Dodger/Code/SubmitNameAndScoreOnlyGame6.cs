...
public class SubmitNameAndScoreOnlyGame6 : MonoBehaviour
{
    ...
    private string submitScoreURL = "https://ourgoodguide.com/HTML5DesktopProject/ScoreandNameSubmission/submit_score_game_6.php";
    private string checkRankURL = "https://ourgoodguide.com/HTML5DesktopProject/CheckRank/check_rank_game_6.php";
    private int score = 0;

    private void Start()
    {
        score = PlayerPrefs.GetInt("Game6_SubmitScore", 0);
    ...
    public IEnumerator SubmitScoreAndCheckRank(string playerName, int score)
    {
        ...
        PlayerPrefs.DeleteKey("Game6_SubmitScore");
    }
    ...
    {
        SceneManager.LoadScene("Gameplay Game 6"); // 🔹 Correct retry scene
    }
}
